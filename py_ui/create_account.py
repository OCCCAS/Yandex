...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(520, 120, 341, 341))
...
"")
        ...
        self.lbl_error.setGeometry(QtCore.QRect(520, 480, 339, 41))
        self.lbl_error.setStyleSheet("color: red;")
        self.lbl_error.setText("")
        self.lbl_error.setObjectName("lbl_error")
        self.btn_create_account = QtWidgets.QPushButton(Form)
        self.btn_create_account.setGeometry(QtCore.QRect(520, 540, 339, 37))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
