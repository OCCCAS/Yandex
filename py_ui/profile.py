...
"")
        ...
        self.btn_add_img_to_portfolio_2 = QtWidgets.QPushButton(Form)
        self.btn_add_img_to_portfolio_2.setGeometry(QtCore.QRect(10, 90, 171, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.btn_add_img_to_portfolio_2.setFont(font)
        self.btn_add_img_to_portfolio_2.setStyleSheet("background-color: #4654f9;\n"
"border-width: 2px;\n"
"border-radius: 5px;\n"
"color: white;\n"
"")
        self.btn_add_img_to_portfolio_2.setObjectName("btn_add_img_to_portfolio_2")
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_add_img_to_portfolio_2.setText(_translate("Form", "Редактировать профиль"))
